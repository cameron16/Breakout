...
PADDLE_WIDTH  = 125 #80 125 #58
#: the height of the paddle
PADDLE_HEIGHT = 20 #100#20
...
#: list of the color of a brick
BRICK_COLORS=[colormodel.RED,colormodel.RED,colormodel.ORANGE,colormodel.ORANGE,colormodel.YELLOW,colormodel.GREEN,colormodel.GREEN,colormodel.CYAN,colormodel.CYAN]
